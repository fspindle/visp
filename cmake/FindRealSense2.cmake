...
#
# Description:
# Try to find Intel RealSense SDK 2.0 to work with depth cameras (D400 series
# and the SR300).
...
if(MSVC)
  ...
  if(CMAKE_CL_64)
    ...
    list(APPEND REALSENSE2_LIB_SEARCH_PATH "C:/librealsense2/bin/Win32")
